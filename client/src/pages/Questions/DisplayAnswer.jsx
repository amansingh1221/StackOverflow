        ...
        question.answer.map((ans)=>(
          <div className='display-ans' key={ans._id}>
            ...
            <div>
              ...
              <Link to={`/users/${ans.userId}`} className='user-link' style={{ color: '#0086d8' }}><Avatar backgroundColor='#4ced7c' px='8px' py='8px'>{ans.userAnswered.charAt(0).toUpperCase()}</Avatar>
                          <div >
                            {
                              ans.userAnswered
                            }
